...
runall[p_,pdf_,np_,flageps_,e_:1,ne_:1,varsminmax_:{{r1,0,1}},epscons_:(-0.01<=eps<=0.01),varscons_:(r1==0||r1==1),file_:"ch0x.csv"] := Module[
	{
	},
	If[flageps==False,If[Maximize[{eps,epscons},eps][[1]]==0,newepscons:=(-0.01<=eps<=0.01),newepscons:=epscons]];
	...
	Print[""];
	If[continuous, Get[Directory[]<>"/mathematica/base_runall_cont.m"], Get[Directory[]<>"/mathematica/base_runall_disc.m"]];
